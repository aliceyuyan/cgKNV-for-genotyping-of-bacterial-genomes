%/home/alice/software/matlab_R2025b/bin/matlab  --nosplash   --nodesktop
...
txtc2 ='';
txtc2 = textread('../Accession_ID_list.txt','%s','delimiter','\n','whitespace','','bufsize', 4095000);
name_list='';
...
for i1=1:length(measures)
    ...
    save(strcat('cgKNV_distance_matrix_',measure,'.mat'),'M');

    outputfilename=strcat('cgKNV_distance_matrix_',measure,'.meg');
    num_of_seq=taxanum;
